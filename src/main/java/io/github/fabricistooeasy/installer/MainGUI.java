package io.github.fabricistooeasy.installer;
...
public class MainGUI extends JFrame {
    ...
    public MainGUI() throws HeadlessException {
        super("Fabric Loader Installer");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLocationRelativeTo(getOwner());
        setSize(500, 200);
        setLayout(new FlowLayout());
        JPanel gameVersionPanel = new JPanel();
        gameVersionPanel.add(new JLabel("Game Version: 1.6.4-MITE"));
        add(gameVersionPanel, BorderLayout.NORTH);
        JPanel loaderVersionPanel = new JPanel();
        loaderVersionPanel.add(new JLabel("Fabric Loader Version:"));
        JComboBox<String> loaderVersionCombo = new JComboBox<>();
        new Thread(() -> {
            String xml = readString("https://maven.fabricmc.net/net/fabricmc/fabric-loader/maven-metadata.xml");
        ...
        install.addActionListener(e -> {
            ...
            if (loaderVersion == null) {
                ...
                try {
                    ...
                    String name = String.format("fabric-loader-%s-1.6.4-MITE", loaderVersion);
                    ...
                    JOptionPane.showMessageDialog(null, "Fabric Loader for 1.6.4 MITE has been successfully installed into your game directory.\nYou might need to get a copy of MITE R196 in your game directory as well.");
